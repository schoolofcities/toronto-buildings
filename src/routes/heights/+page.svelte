<script>
	...
	onMount(async () => {
		...
		map.on("load", () => {
			...
			// 			buildingHeights[6], heightColors[6]
			// 		],
			// 		"fill-extrusion-height": ["get", "AVG_HEIGHT"], // height in meters
...
<main>
	...
	<div id="map-credits">
		Map by <a href="https://jamaps.github.io/" target="_blank">Jeff Allen</a> at the <a href="https://schoolofcities.utoronto.ca/" target="_blank">School of Cities</a> built using <a href="https://github.com/felt/tippecanoe" target="_blank">tippecanoe</a>, <a href="https://github.com/protomaps/PMTiles" target="_blank">PMTiles</a>, <a href="https://github.com/maplibre/maplibre-gl-js" target="_blank">MapLibre</a>, and data from the <a href="https://open.toronto.ca/dataset/3d-massing/" target="_blank">City of Toronto</a>.
	</div>
